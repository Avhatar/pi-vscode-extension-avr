...
8. **Part X — standalone desktop host** *(retired 2026-07-22)*. Historical snapshot of the Electron-based alternate host; the code was removed from the working tree. Its successor lives in the private [`pi-code-standalone`](https://github.com/Avhatar/pi-code-standalone) submodule at [`standalone/`](../standalone/) and is documented there.
...
Historical snapshot of the Electron-based alternate host that reused the portable chat core. The Electron implementation was removed from the working tree on 2026-07-22. Its successor lives in the private [`pi-code-standalone`](https://github.com/Avhatar/pi-code-standalone) submodule at [`standalone/`](../standalone/) and is documented there. Articles below are kept as reference for what the retired Electron system looked like.
