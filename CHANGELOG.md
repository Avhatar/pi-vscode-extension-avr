...
### Changed
- Continued the shared session-runtime extraction by moving Pi session logging, workspace discovery, trust, typed settings, secrets, and model dialogs behind platform-neutral ports.
